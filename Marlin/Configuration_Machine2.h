...
#define STRING_CONFIG_H_AUTHOR "15.04.6-RC2 DD #2" // Who made the changes.
#endif
...
#define DEFAULT_MAX_ACCELERATION      {1200,1200,100,500}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
